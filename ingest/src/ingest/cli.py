...
from ingest.pipeline import IngestPipeline, PipelineContext
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Ingestion Pipeline.\n"
            "NOTE: Please update 'core/src/core/config/definitions/ingest.yaml' "
    ...
    # Base dir: repo-root data directory
