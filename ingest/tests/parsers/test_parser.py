...
def test_parse_match_row_incomplete_teams(id_map, rank_ctx):
    info = {
        "gameMode": "CLASSIC",
        "participants": [
            {"teamId": 100, "championName": "Annie", "teamPosition": "MIDDLE"}
        ],
    }
...
def test_parse_match_row_invalid_roles(id_map, rank_ctx):
    ...
    info = {
        "gameMode": "CLASSIC",
        "participants": [
            {"teamId": 100, "championName": "Annie", "teamPosition": "INVALID"}
        ],
    }
    data = {"metadata": {"matchId": "M1"}, "info": info}
...
def test_parse_match_row_missing_bans_map(rank_ctx):
    ...
    info = {
        "gameMode": "CLASSIC",
        "participants": 5
        * [{"teamId": 100, "championName": "A", "teamPosition": "TOP"}]
    ...
    red = [
        {"teamId": 200, "championName": "B", "teamPosition": "TOP", "win": False}
    ] * 5
