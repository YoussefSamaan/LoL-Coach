...
from ml.training import ArtifactStats, ManifestData, LiftStat
...
class TestArtifactBundle:
    ...
    def test_bundle_immutability(self):
        ...
        stats = ArtifactStats(
            role_strength={}, synergy={}, counter={}, global_winrates={}
        )
        manifest = ManifestData(
            run_id="test", timestamp=1.0, rows_count=100, source="/data"
        )
